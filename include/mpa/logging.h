#ifndef __MYSTIC_PRECISION_ARM_LOGGING_H__
#define __MYSTIC_PRECISION_ARM_LOGGING_H__
...
// MPA_LOG: Allows explicit LogLevel specification.
#define MPA_LOG(level, format, ...) mpa::_internal_log_impl(level, __FILE__, __LINE__, __func__, format, ##__VA_ARGS__)

// MPA_LOG_*: Pre-defined level macros for common use.
#define MPA_LOG_TRACE(format, ...) MPA_LOG(mpa::LogLevel::Trace, format, ##__VA_ARGS__)
#define MPA_LOG_DEBUG(format, ...) MPA_LOG(mpa::LogLevel::Debug, format, ##__VA_ARGS__)
#define MPA_LOG_INFO(format, ...)  MPA_LOG(mpa::LogLevel::Info,  format, ##__VA_ARGS__)
#define MPA_LOG_WARN(format, ...)  MPA_LOG(mpa::LogLevel::Warning, format, ##__VA_ARGS__)
#define MPA_LOG_ERROR(format, ...) MPA_LOG(mpa::LogLevel::Error, format, ##__VA_ARGS__)
#define MPA_LOG_FATAL(format, ...) MPA_LOG(mpa::LogLevel::Fatal, format, ##__VA_ARGS__)
...
#endif // __MYSTIC_PRECISION_ARM_LOGGING_H__
